    ...
    return (
        <div>
          ...
          <Grid container sx={{justifyContent:'center'}} xs={9} md={5} lg={5}>
            ...
            <br/>
            <br/>
              For the first time in a decade, Pepsi will not be sponsoring the Super Bowl halftime show. This is because it intends to move towards digital platforms. YouTube is one of the biggest digital platforms that exists today. YouTube was introduced in 2005 with the famous “Me at the Zoo” video and over the past decade has taken the world by storm with users now watching 6 billion hours of videos every month. Some of the most popular references to the internet cat videos, double rainbow, jazz hands, and the infamous rickrolling as well as popular musicians have had their start on Youtube.
              <br/>
              <br/>
            ...
            <p>
              ...
              <br/>
              <br/>
              While TikTok may be competing with Youtube in engagement rates, TikTok does not provide users with the same benefits that the Youtube platform does. Youtube affords its content creators the ability to create longer-form content and long-term stability on a platform. In addition to Youtube’s creator features, Youtube now also grants the creators on their platform to create shorter form content through Youtube Shorts.
            </p>
          </Grid>
          </div>
        </div>
